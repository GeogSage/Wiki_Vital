...
#import pandas to maipulate tables
import pandas as pd
...
page_list = {'page': [], 'watchers': [], 'pageviews': [], 'pageviews_offset': [],
           'revisions': [], 'editors':[],  'created_at': [], 'links_ext': [], 'links_out': [], 'links_in': [],
             'redirects': []}
